...
#'
#' @param object A \code{Sincast} object.
#' @param Sincast.assay description
#' @param Seurat.assay description
#' @param layer description
#' @param reference.features description
#' @param query.features description
#' @param ScaleData.control description
#' @param RunPCA.control description
#'
#' @return A \code{Sincast} object with updated \code{Sincast} atlas.
#'
#' @family SincastAtlas related methods
